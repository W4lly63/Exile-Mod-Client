...
//Class C:\Users\MusTanG\Documents\Arma 3\missions\configdump.Tanoa\config.bin{
class CfgPatches
{
	class exile_client
	{
...
class CfgConstruction
{
	...
	class ConcreteFloorHatch: AbstractFloor
	{
		...
		kitMagazine = "Exile_Item_ConcreteFloorHatchKit";
		refundObjects[] = {"Exile_Item_ConcreteFloorHatchKit"};
		materialType = 12;
	};
	...
	class ConcreteWindowHatch: AbstractWall
	{
		...
		kitMagazine = "Exile_Item_ConcreteWindowHatchKit";
		refundObjects[] = {"Exile_Item_ConcreteWindowHatchKit"};
		materialType = 12;
	};
...
class CfgNetworkMessages
{
	...
	class joinLoneWolfGroupRequest
	{
		module = "system_group";
		parameters[] = {};
	};
...
class RscExileDevBlog
{
	idd = 24033;
	access = 3;
	duration = -1;
	onLoad = "uiNamespace setVariable ['RscExileDevBlog', _this select 0]; with uiNameSpace do { [_this select 0, 'RscExileDevBlog'] call ExileClient_gui_loadingScreen_load; };";
	onUnload = "with uiNameSpace do { (_this select 0) call ExileClient_gui_loadingScreen_unload; }; uiNamespace setVariable ['RscExileDevBlog', displayNull]";
	class controlsBackground
	{
		class ExileBlackBackground: RscText
		{
	...
	class controls
	{
		...
		class ExileNewsHTML: RscHTML
		{
			idc = 24000;
			x = "safeZoneX + (60 + 15) * pixelW";
			y = "safeZoneY + (60 + 60 + 15) * pixelH";
			w = "safeZoneW - (60 + 60 + 380 + 60 + 15 + 15) * pixelW";
		...
		class ButtonContinue: RscExilePrimaryButton
		{
			idc = 24003;
			text = "OKAY";
			x = "safeZoneX + (60 + 15) * pixelW";
			...
			w = "300 * pixelW";
			h = "60 * pixelH";
			onButtonClick = "uiNameSpace setVariable ['ExileClientDevBlogOkayClicked', true]";
		};
	};
};
...
class RscMPSetupMessage
{
	...
	class Controls
	{
		...
		delete Progress;
		delete ProgressIcon;
		delete CA_MPSetupMessageTitle;
		delete CA_Progress;
		delete BackgroundFull;
		delete BackgroundProgress;
				...
				class SlideMobileXm8: RscExileXM8Slide
				{
					...
					class Controls
					{
						class Description: RscStructuredText
						{
							...
							h = "12 * (0.04)";
							colorBackground[] = {0,0,0,0.25};
							text = "<t size='1.5'>Never miss a base raid!<br/><br/></t>Use the code to the left to link your smartphone with your in-game character. You will then receive notifications about base raids, protection money reminders and more!<br/><br/><a href='http://www.exilemod.com/xm8'>Get the app</a>";
							size = "24 * pixelH";
							class Attributes
							{
								align = "left";
						...
						{
							idc = -1;
							text = "<t valign='middle' align='center' shadow='0'><a href='http://www.exilemod.com/'><img image='exile_assets\texture\ui\google_play_ca.paa'></a></t>";
							x = "2 * (0.025)";
							y = "9 * (0.04)";
							w = "9 * (0.025)";
							h = "3 * (0.04)";
